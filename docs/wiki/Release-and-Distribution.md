...
- VSIX asset: `glyph-compress-1.14.0.vsix`
...
```bash
gh release view v1.14.0 --json tagName,isDraft,isPrerelease,assets,url
```
...
Expected Marketplace version: `1.14.0` after Marketplace publish.
...
```text
neolambo.glyph-compress@1.14.0
```
